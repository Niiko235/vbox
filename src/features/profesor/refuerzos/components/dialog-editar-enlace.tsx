...
import { editarEnlace } from '../actions/editar-enlace'
...
type Props = {
  enlace:          EnlaceRefuerzo
  onEnlaceEditado: (enlace: EnlaceRefuerzo) => void
}

export function DialogEditarEnlace({ enlace, onEnlaceEditado }: Props) {
  ...
  const form = useForm<FormData>({
    ...
    defaultValues: {
      ...
      puntuacion: String(enlace.puntuacion),
    },
  })
  ...
  async function onSubmit(data: FormData) {
    ...
    setSubmitting(true)
    try {
      const result = await editarEnlace({
      ...
      setErrorMsg('Error inesperado al editar el enlace')
    } finally {
      setSubmitting(false)
    }
  }
