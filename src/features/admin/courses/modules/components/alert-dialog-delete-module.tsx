...
import { deleteModule } from "../actions/delete-module";
...
export function AlertDialogDeleteModule({ id, nombreModulo, handleEliminar }: Props) {
  ...
  async function handleDelete() {
    ...
    try {
      ...
      if (!response.ok) {
        setFormStatus({
          status: "error",
          message: response.message || "Error desconocido al eliminar el módulo",
        });
        return;
      }
      ...
      setFormStatus({
        status: "error",
        message: "Error desconocido al eliminar el módulo",
      });
    }
  }
    ...
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <AlertDialogContent size="sm">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ¿Estás seguro de querer eliminar este módulo? Esta acción no se
